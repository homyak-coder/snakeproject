/**
 *@file snake_model.cpp
*/
#include "../headers/snake.hpp"
/**
 * @brief Функция для выдержки частоты обновления модели
...
/**
 * @brief Даёт знать о завершении игры
 * @return true, если модель не завершена, false в обратном случае
 */
 ...
 * @param w ширина в клетках
 * @param h высота в клетках
 * @param f частота обновления модели
 * @param difficulty скорость роста частоты обновления модели
 */
...
/**
 * @brief Получает команду и развивает соответствующий ей сценарий
 * @param cmd Команда
 *
 */
...
/**
 * @brief Возвращает двумерный вектор состояний каждой клетки
 * @return двумерный вектор состояний поля модели
 */
